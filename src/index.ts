...
var game = new Phaser.Game(800, 600, Phaser.CANVAS, 'STATE_WORLD', { create: create });
...
function createUI() {
  ...
  var frame0 = [
      ...
      // this.game.create.texture('yourKey', frame0, 6, 6, 0);
...
function onDown(pointer) {
  ...
  if (pointer.y <= 32) {
    var g: any = game;
    setColor(g.math.snapToFloor(pointer.x, 32) / 32, undefined);
  }
  else {
    isDown = true;
